...
public class InsidePresentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inside_present);

        questionTV = findViewById(R.id.p_question);
        idTV = findViewById(R.id.p_id);
        container = findViewById(R.id.p_container);
        nextBtn = findViewById(R.id.p_next);
        backBtn = findViewById(R.id.p_back);
        shareBtn = findViewById(R.id.p_share);

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InsidePresentActivity.this, DashBoardActivity.class);
        ...
        reference.child("GrammarSimplePresent").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (list.size() > 0){
                    ...
                    nextBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (position == list.size()){
                                Intent intent = new Intent(InsidePresentActivity.this, ScoreActivity.class);
                    ...
                    Toast.makeText(InsidePresentActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(InsidePresentActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
