...
public class Vocab2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Vocab2Activity.this, DashBoardActivity.class);
        ...
        reference.child("Questions 2").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (list.size() > 0){
                    ...
                    nextBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (position == list.size()){
                                Intent intent = new Intent(Vocab2Activity.this, ScoreActivity.class);
                    ...
                    Toast.makeText(Vocab2Activity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Vocab2Activity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void checkAnswer(Button selectedOption) {
        ...
        if (selectedOption.getText().toString().equals(list.get(position).getAnswer())) {
            ...
            if (correctOption != null) {  // Check if the button exists
