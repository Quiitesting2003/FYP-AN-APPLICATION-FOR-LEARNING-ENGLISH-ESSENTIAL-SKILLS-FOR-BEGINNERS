...
public class ProfileVnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_vn);
        ...
        // Initialize views
        avatarImageView = findViewById(R.id.iv_avatar_profilevn);
        fullNameEditText = findViewById(R.id.et_full_namevn);
        dateOfBirthEditText = findViewById(R.id.et_date_of_birthvn);
        emailEditText = findViewById(R.id.et_emailvn);
        phoneNumberEditText = findViewById(R.id.et_phone_numbervn);
        genderSpinner = findViewById(R.id.spinner_gendervn);
        profileContinueButton = findViewById(R.id.profileVn_continue_button);
        backButton = findViewById(R.id.back_profile_buttonvn);
        ...
        backButton.setOnClickListener(v -> startActivity(new Intent(ProfileVnActivity.this, SignInVnActivity.class)));
        profileContinueButton.setOnClickListener(v -> {
            if (handleProfileUpdate()) {
                startActivity(new Intent(ProfileVnActivity.this, FirstSurveyActivity.class));
            }
        });
    ...
    private String formatPhoneNumber(String phoneNumber) {
        ...
        else return digits.substring(0, 3) + "-" + digits.substring(3, 6) + "-" + digits.substring(6, Math.min(digits.length(), 9));
    }
    ...
    private void saveUserDataToFirebase(String fullName, String dateOfBirth, String email, String phoneNumber, String gender) {
        ...
        databaseReference.updateChildren(userData)
                ...
                .addOnFailureListener(e -> Toast.makeText(this, "Không cập nhật được thông tin", Toast.LENGTH_SHORT).show());
    }
    ...
    private void retrieveUserDataFromFirebase() {
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("ProfileActivity", "Không đọc được dữ liệu người dùng", databaseError.toException());
            }
        });
    }
