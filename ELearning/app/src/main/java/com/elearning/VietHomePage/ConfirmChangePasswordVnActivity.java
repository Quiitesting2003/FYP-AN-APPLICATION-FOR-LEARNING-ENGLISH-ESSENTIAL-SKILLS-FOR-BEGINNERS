...
public class ConfirmChangePasswordVnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_change_password_vn);

        // Initialize Firebase Authentication
        mAuth = FirebaseAuth.getInstance();

        // Initialize views
        Button backButton = findViewById(R.id.conPass_back);
        newPasswordEditText = findViewById(R.id.conPass_pass);
        confirmPasswordEditText = findViewById(R.id.conPass_con);
        currentPasswordEditText = findViewById(R.id.et_current_password_vn);  // New EditText for current password
        ...
        ImageView continueButton = findViewById(R.id.conPass_continue);
    ...
    private void showToast(String message) {
        Toast.makeText(ConfirmChangePasswordVnActivity.this, message, Toast.LENGTH_SHORT).show();
    }
        ...
        user.updatePassword(newPassword)
                .addOnCompleteListener(updateTask -> {
                    if (updateTask.isSuccessful()) {
                        ...
                        Intent intent = new Intent(ConfirmChangePasswordVnActivity.this, SignInActivity.class);
