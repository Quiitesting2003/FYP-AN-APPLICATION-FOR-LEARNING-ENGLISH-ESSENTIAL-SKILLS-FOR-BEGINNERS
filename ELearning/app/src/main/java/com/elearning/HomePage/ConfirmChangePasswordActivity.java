...
public class ConfirmChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize views
        Button backButton = findViewById(R.id.ccp_back);
        newPasswordEditText = findViewById(R.id.cc_newPass);
        confirmPasswordEditText = findViewById(R.id.ccp_confirmPass);
        ...
        ImageView continueButton = findViewById(R.id.ccp_continue);
    ...
    private void showToast(String message) {
        Toast.makeText(ConfirmChangePasswordActivity.this, message, Toast.LENGTH_SHORT).show();
    }
        ...
        user.updatePassword(newPassword)
                .addOnCompleteListener(updateTask -> {
                    if (updateTask.isSuccessful()) {
                        ...
                        Intent intent = new Intent(ConfirmChangePasswordActivity.this, SignInActivity.class);
